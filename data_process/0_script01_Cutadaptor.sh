...
inputdir=01_Demultiplexed_fastaq #inputdir is the directory name contains all fastq
outputdir=02_Cutadaptor_fastaq
fseq=NNNNNNGTGYCAGCMGCCGCGGTAA #16S V4 515f
rseq=NNNNNNGGACTACNVGGGTWTCTAAT #16S V4 806rB
thread=32
# cutadaptpath=** #write the path where "cutadapt" is
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ ##
